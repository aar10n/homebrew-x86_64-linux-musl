class ${FORMULA_CLASS} < Formula
  ...
  depends_on "aar10n/x86_64-linux-musl/${VERSIONED_FORMULA}"
  ...
  def install
    ...
    versioned_formula = Formula["aar10n/x86_64-linux-musl/${VERSIONED_FORMULA}"]
    ...
    (prefix/"WRAPPER_FORMULA").write <<~EOS
      ...
      The actual toolchain is provided by: ${VERSIONED_FORMULA}
  ...
  def caveats
    ...
    <<~EOS
      This is a wrapper formula for ${VERSIONED_FORMULA}.
